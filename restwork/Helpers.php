...
class Helpers
{
    ...
    {
        return static::arrayMapRecursive(array(__NAMESPACE__.'\\Helpers', 'htmlspecialchars'), $array, $onKeys);
    }
    ...
    {
        return static::arrayMapRecursive(array(__NAMESPACE__.'\\Helpers', 'htmlentities'), $array, $onKeys);
    }
